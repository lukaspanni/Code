...
//light Colors + Position
float ambientColor[3] = { 0.1, 0.1, 0.1 };
float diffuseColor[3] = { 0.29, 0.25, 0.25 };
float specularColor[3] = { 0.6, 0.6, 0.6 };
float light0Position[4] = { 0, 20, 10, 1 };
float light1Position[4] = { 0, -20, 10, 1};
...
int main(int argc, char** argv)
{
	...
	glutInit(&argc, argv);
	glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGB | GLUT_DEPTH | GLUT_MULTISAMPLE); // Doublebuffer for animation
...
void display(void) {
	...
	if (lights == 1) {
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// LIGHT DEFINITION: COLOR + POSITION
